...
<head>
    ...
    <!-- Website Title -->
    <title>IoT- Sri Reskita Syamsuri</title>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">IoT-1 </span> Arkatama</h1>
                            <p class="p-large">Internet of Things (IoT) is a concept that is connected to devices as an internet-based communication medium. With IoT, users can connect and communicate with each other to carry out certain activities, search, process and send information automatically.</p>
